...
public class RSAUtils {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, IllegalBlockSizeException, InvalidKeyException, BadPaddingException, InvalidKeySpecException, NoSuchPaddingException {
        ...
        String publicKey = keys.get(PUBLICKEY_NAME);
        String privateKey = keys.get(PRIVATE_NAME);
        System.out.println("公钥:" + publicKey);
        System.out.println("私钥:" + privateKey);


//        String testStr = "abcdefg";
        String testStr = "这里是测试字符串";

        System.out.println("测试字符串:" + testStr);


        String rs = publicKeyEncrypt(testStr, publicKey);
        System.out.println("公钥加密" + rs);
        rs = privateKeyDecrypt(rs, privateKey);
        System.out.println("私钥解密" + rs);


        System.out.println("========================");

        rs = privateKeyEncrypt(testStr, privateKey);
        System.out.println("私钥加密" + rs);
        rs = publicKeyDecrypt(rs, publicKey);
        System.out.println("公钥解密" + rs);
    }
}
